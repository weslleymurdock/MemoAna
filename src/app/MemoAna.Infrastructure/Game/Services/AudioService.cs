...
public sealed partial class AudioService(IAudioManager manager, IRepository repository) : IAudioService, IDisposable
{
    ...
    {
        GameSettingsEntity? currentConfig = (await repository
            .GetAsync<GameSettingsEntity>())
            .SingleOrDefault();
