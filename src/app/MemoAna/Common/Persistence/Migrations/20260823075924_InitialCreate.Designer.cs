...
namespace MemoAna.Common.Persistence.Migrations
{
    ...
    [Migration("20260823075924_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemoAna.Game.Entities.CardThemeEntity", b =>
                {
            ...
            modelBuilder.Entity("MemoAna.Game.Entities.CardThemeManifestEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MemoAna.Game.Entities.GameSettingsEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("MemoAna.Game.Entities.GameStatisticsEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MemoAna.Game.Entities.CardThemeEntity", b =>
                {
                    b.HasOne("MemoAna.Game.Entities.CardThemeManifestEntity", "Manifest")
                        .WithOne("CardTheme")
                        .HasForeignKey("MemoAna.Game.Entities.CardThemeEntity", "ManifestId")
            ...
            modelBuilder.Entity("MemoAna.Game.Entities.GameSettingsEntity", b =>
                {
                    b.OwnsOne("MemoAna.Game.Models.GameOptions", "Options", b1 =>
                        {
