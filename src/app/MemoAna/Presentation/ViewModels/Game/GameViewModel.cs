...
public partial class GameViewModel(IGameService gameService, IAudioService audioService) : ViewModelBase, IQueryAttributable
{
    [ObservableProperty]
